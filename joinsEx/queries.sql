...
-- owner_id. Your output should look like this:
SELECT *
FROM owners o
...
-- of vehicles. The first_name should be ordered in ascending order. Your output should look 
-- like this:
...
-- first_name should be ordered in descending order. Only display results with more than one vehicle
